...
loads these modules in dependency order, and routes the two supported
...
- Command exit status matches the report: core home-lab failures return
  nonzero; notes and secondary-service warnings stay nonblocking.

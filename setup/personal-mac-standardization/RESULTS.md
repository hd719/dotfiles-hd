...
- An actual-tool temporary-home run using Homebrew, mise, uv, npm, and Neovim:
  ...
  - interactive and non-interactive login shells resolved Node 22.23.1, pnpm
...
- `cortana-services` at detached clean commit
  ...
  frozen install, `pnpm ci:local`, and `go test ./...` all passed.
- Personal Next.js/Bun repository at commit
  `fc54e31fbd0608b909b552815a285bf62e6610f9`: Bun 1.3.14 frozen install and
  lint passed, and the checkout stayed clean.
...
- Local host preparation installed missing Homebrew `gopls` and
  ...
  live dotfile link or active PATH was switched.

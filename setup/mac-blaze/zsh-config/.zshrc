...
## Databasees
alias blaze-restore="~/Developer/dotfiles-hd/setup/mac-blaze/zsh-config/scripts/db/restore.sh"
alias blaze-backup="~/Developer/dotfiles-hd/setup/mac-blaze/zsh-config/scripts/db/backup.sh"

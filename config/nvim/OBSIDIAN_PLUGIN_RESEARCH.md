...
| Snacks image           | Good. It is the plugin's supported inline-image backend. Obsidian-style attachment paths need the documented [resolver hook](https://github.com/obsidian-nvim/obsidian.nvim/blob/v3.16.5/docs/Images.md#inline-image-viewing). PDF rendering remains a Snacks feature; Obsidian attachment links use `vim.ui.open` by default. |
